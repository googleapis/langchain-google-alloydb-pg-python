...
def get_row(doc_id: str, score: float, content: str = "content") -> dict:
    ...
    the initial score/distance as the last value when casting the RowMapping to a list of values.
    ...
    # This structure ensures list(row.values())[0] is doc_id and list(row.values())[-1] is score.
...
class TestReciprocalRankFusion:
    ...
    def test_reordering_from_inputs_weighted_sum(self):
        ...
        This is different from Primary (A,B) and Secondary (B,A in terms of original scores,
        but the fusion logic changes the effective contribution).
        """
