...
def weighted_sum_ranking(
    ...
    Args:
        primary_search_results: A list of (document, distance) tuples from the primary search.
        secondary_search_results: A list of (document, distance) tuples from the secondary search.
    ...
    # Process results from secondary source, adding to existing scores or creating new ones
