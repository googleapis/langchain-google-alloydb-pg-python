...
# TODO Move to AlloyDBEngine Implementation from Vectorstore PR once it is merged
...
class AlloyDBDocumentSaver:
    ...
    def __init__(
        ...
        """
        AlloyDBDocumentSaver allows for saving of langchain documents in dataabase. If the table
